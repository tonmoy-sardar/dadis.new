...
/**
 * Generated class for the OrderfailurePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */

@IonicPage({ segment: 'orderfailure/:id' })
@Component({
  selector: 'page-orderfailure',
  templateUrl: 'orderfailure.html',
})
export class OrderfailurePage {
  ...
  constructor(
    ...
    public events: Events,
      ...
      this.events.publish('page-name', 'Order Failure');
    }
